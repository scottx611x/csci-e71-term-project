...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="description" id="description" value='{{ old('description', $computertype->description) }}' maxlength="50" placeholder="Description" required="required">
